...
{
  static const bool isBigEndian = (QSysInfo::ByteOrder == QSysInfo::BigEndian);
...
template <typename TFloat, typename TInt, QSysInfo::Endian ENDIAN>
...
template <QSysInfo::Endian ENDIAN>
...
{
  return fromFloat<float, uint, QSysInfo::LittleEndian>(value);
}

ByteVector ByteVector::fromFloat32BE(float value)
{
  return fromFloat<float, uint, QSysInfo::BigEndian>(value);
}

ByteVector ByteVector::fromFloat64LE(double value)
{
  return fromFloat<double, ulonglong, QSysInfo::LittleEndian>(value);
}

ByteVector ByteVector::fromFloat64BE(double value)
{
  return fromFloat<double, ulonglong, QSysInfo::BigEndian>(value);
}
...
{
  return toFloat<float, uint, QSysInfo::LittleEndian>(*this, offset);
}

float ByteVector::toFloat32BE(size_t offset) const
{
  return toFloat<float, uint, QSysInfo::BigEndian>(*this, offset);
}

double ByteVector::toFloat64LE(size_t offset) const
{
  return toFloat<double, ulonglong, QSysInfo::LittleEndian>(*this, offset);
}

double ByteVector::toFloat64BE(size_t offset) const
{
  return toFloat<double, ulonglong, QSysInfo::BigEndian>(*this, offset);
}

long double ByteVector::toFloat80LE(size_t offset) const
{
  return toFloat80<QSysInfo::LittleEndian>(*this, offset);
}

long double ByteVector::toFloat80BE(size_t offset) const
{
  return toFloat80<QSysInfo::BigEndian>(*this, offset);
}
